'use client'
import { getUserProfileDetails } from "@/lib/actions/profile";
...
export default function ProfilePage(){
    ...
    useEffect(()=>{
        async function loadProfile(){
            try {
                const profileDataofTheUser=await getUserProfileDetails()
                if(profileDataofTheUser){
                    setProfile(profileDataofTheUser)
                    console.log(profileDataofTheUser)
                }else{
                                ...
                                <div className="flex items-center space-x-6 mb-8">
                                    <div className="relative">
                                        <div className="w-24 h-24 rounded-full overflow-hidden">
                                            <img
                                                src={profile.avatar_url || "/user-image.jpg"}
